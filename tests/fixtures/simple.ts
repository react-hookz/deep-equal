...
export default [
...

  {
    ...
    tests: [
      ...
      {
        description: 'objects with different `valueOf` functions returning same values are equal',
        value1: { valueOf: () => 'Hello world!' },
        value2: { valueOf: () => 'Hello world!' },
        equal: true,
      },
      {
        description: 'objects with `valueOf` functions returning different values are not equal',
        value1: { valueOf: () => 'Hello world!' },
        value2: { valueOf: () => 'Hi!' },
        equal: false,
      },
